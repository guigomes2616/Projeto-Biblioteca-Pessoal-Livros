...
namespace Cadastro_Livro // Declara o namespace Cadastro_Livro
{
    public class Login // Declara a classe pública Login
    {
        ...
        public Login(string user, string pass) // Declara um construtor público para a classe Login que recebe um e-mail e uma senha como parâmetros
        {
            this.useremail = user; // Atribui o valor do parâmetro user à propriedade useremail da classe
